...
@Autonomous(name = "P Red", preselectTeleOp = "Red TeleOp")
public class PRed extends BaseOpMode {
    //STARTING LOCATION
    ...
    public void rightAuto() {
        ...
        Trajectory toAllianceHub = robot.drivetrain.trajectoryBuilder(robot.drivetrain.getPoseEstimate(), true, 10, 5)
                .back(24)
                .build();
