...
public class DriveModule {
    ...
    public final double TICKS_PER_MODULE_REV = 8192; //20 * (double)(60)/14 * (double)(48)/15 * (double)(82)/22; //ticks per MODULE revolution
    ...
    public final double TICKS_PER_WHEEL_REV = 1 * TICKS_PER_MODULE_REV_ORIENT;// * 18/60; //ticks per WHEEL revolution
    ...
    public DriveModule(Robot robot, ModuleSide moduleSide, boolean debuggingMode) {
        ...
        if (moduleSide == ModuleSide.RIGHT) {
            ...
            encoderOrientation = robot.hardwareMap.dcMotor.get("intake");
